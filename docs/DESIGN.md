...
Dark, premium "concierge" theme: navy and indigo canvas with a gold accent, glassmorphism top bar, soft fade-in motion. Not a generic admin-dashboard look.
...
`html { color-scheme: dark }`. The app is dark-mode only; there is no light theme toggle.
