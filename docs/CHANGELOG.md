...
- **fix(analytics):** management dashboard/analytics charts now derive dining trend and member engagement from real bookings/reservations/guests data, closing the last mock-data surface in the app (`lib/domain/analytics.ts` deleted).
