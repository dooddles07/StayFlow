  ...
  return (
    <div className="flex min-h-dvh bg-canvas">
      <div className="relative hidden w-[42%] flex-col justify-between overflow-hidden bg-surface p-10 lg:flex">
        ...
        <p className="relative text-[11px] text-muted-text/60">
          StayFlow Operations
        </p>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm animate-fade-in">
          ...
          <h2 className="mt-2 text-2xl font-semibold tracking-tight text-foreground">
            Clock in to your console
          </h2>
          <p className="mt-2 text-sm text-muted-text">
            Enter your operations credentials to continue.
          </p>
          ...
          <p className="mt-6 text-center text-[11px] text-muted-text/60">
            Need staff access? Contact your operations manager.
          </p>
        </div>
      </div>
    </div>
