  ...
  return (
    <div className="mx-auto max-w-6xl">
                ...
                <div className="flex shrink-0 gap-1.5">
                  {isManagement && r.loginStatus === 'none' && (
                    <Button
                      ...
                      onClick={() =>
                        setConfirmLoginTarget({ id: r.id, name: r.name })
                      }
                    >
              ...
              >
                ...
                <div className="flex shrink-0 gap-1.5">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setDeleteTarget({ kind: 'staff', id: s.id, name: s.name })
                    }
                  >
                    <Trash2 className="size-3.5" />
                  </Button>
        ...
        <SheetContent className="border-border bg-surface text-foreground">
          <SheetHeader>
            <SheetTitle className="text-foreground">
              {editingResident?.id ? 'Edit Member' : 'Add Member'}
            </SheetTitle>
          </SheetHeader>
          {editingResident && (
            <div className="space-y-4 px-4 pb-6">
              ...
              <div>
                ...
                <Select
                  value={editingResident.tier}
                  onValueChange={(v) =>
                    setEditingResident({
                      ...editingResident,
                      tier: v as ResidentTier,
                    })
                  }
                >
                  <SelectTrigger
              ...
              {!editingResident.id && isManagement && (
                <label className="flex items-start gap-2.5 rounded-xl border border-border bg-canvas p-3">
                  <Checkbox
                    ...
                    onCheckedChange={(v) => setCreateLoginToo(!!v)}
                    className="mt-0.5"
                  />
            ...
            <div className="space-y-4 px-4 pb-6">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setEditingStaff({ ...editingStaff, role: v })
                  }
                >
                  <SelectTrigger
                    id="staff-role"
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setEditingStaff({ ...editingStaff, shift: v as StaffShift })
                  }
                >
                  <SelectTrigger
                    id="staff-shift"
      ...
      <AlertDialog
        ...
        onOpenChange={(open) => !open && setConfirmLoginTarget(null)}
      >
        <AlertDialogContent className="border-border bg-surface text-foreground">
          <AlertDialogHeader>
            <AlertDialogTitle>
      ...
      <Dialog
        open={!!revealedLogin}
        onOpenChange={(open) => !open && setRevealedLogin(null)}
      >
