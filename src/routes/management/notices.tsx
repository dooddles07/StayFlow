            ...
            >
              <div className="min-w-0">
                <div className="mb-1 flex items-center gap-2">
                  <span className="rounded-full bg-surface-hover px-2 py-0.5 text-[10px] font-medium text-muted-text">
                    {notice.category}
                  </span>
                  {notice.pinned && (
                    <Pin className="size-3 fill-current text-accent-gold" />
                  )}
                </div>
                ...
                <p className="mt-1 text-[11px] text-muted-text/70">
                  {notice.postedBy}
                </p>
              </div>
            ...
            <div className="space-y-4 px-4 pb-6">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setEditing({ ...editing, category: v as NoticeCategory })
                  }
                >
              ...
              <div className="flex items-center justify-between rounded-xl border border-border bg-canvas px-3.5 py-3">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    setEditing({ ...editing, pinned: checked })
                  }
                />
              </div>
              <Button
