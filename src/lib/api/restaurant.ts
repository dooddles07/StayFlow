...
export const getRestaurant = (id: string) =>
  cachedGet<Restaurant>(`/restaurants/${id}`)
...
export const createRestaurant = (data: RestaurantInput) =>
  api.post<Restaurant>('/restaurants', data).finally(bust)
export const updateRestaurant = (id: string, data: RestaurantInput) =>
  api.put<Restaurant>(`/restaurants/${id}`, data).finally(bust)
export const deleteRestaurant = (id: string) =>
  api.del<void>(`/restaurants/${id}`).finally(bust)
